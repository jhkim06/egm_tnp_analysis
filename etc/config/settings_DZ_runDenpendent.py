...
# flag to be Tested
flags = {
    'nonDZPath' : '(isNonDZPathPassed == 1)',
    'DZPath' : '(isDZPathPassed == 1)' 
   }

baseOutDir = 'results/DZ/tnpEleTrig_rundependent' # JH
...
samplesDef = {
    'data'   : tnpSamples.DZfilter_2016['data_Run2016B'].clone(),
    'data1'   : tnpSamples.DZfilter_2016['data_Run2016C'].clone(),
    'data2'   : tnpSamples.DZfilter_2016['data_Run2016D'].clone(),
    'data3'   : tnpSamples.DZfilter_2016['data_Run2016E'].clone(),
    'data4'   : tnpSamples.DZfilter_2016['data_Run2016F'].clone(),
    'data5'   : tnpSamples.DZfilter_2016['data_Run2016G'].clone(),
    'data6'   : tnpSamples.DZfilter_2016['data_Run2016H'].clone(),
    'mcNom'  : tnpSamples.DZfilter_2016['DY_amcatnlo_Winter17'].clone(),
    'mcAlt'  : None,
...
#samplesDef['data'].add_sample( tnpSamples.DZfilter_2016['data_Run2016G'] )
#samplesDef['data'].add_sample( tnpSamples.DZfilter_2016['data_Run2016F'] )
#samplesDef['data'].add_sample( tnpSamples.DZfilter_2016['data_Run2016E'] )
#samplesDef['data'].add_sample( tnpSamples.DZfilter_2016['data_Run2016D'] )
#samplesDef['data'].add_sample( tnpSamples.DZfilter_2016['data_Run2016C'] )
#samplesDef['data'].add_sample( tnpSamples.DZfilter_2016['data_Run2016B'] )
...
if not samplesDef['data' ] is None:  samplesDef['data' ].set_hltPS(hltPSName)
if not samplesDef['data1' ] is None:  samplesDef['data1' ].set_hltPS(hltPSName)
if not samplesDef['data2' ] is None:  samplesDef['data2' ].set_hltPS(hltPSName)
if not samplesDef['data3' ] is None:  samplesDef['data3' ].set_hltPS(hltPSName)
if not samplesDef['data4' ] is None:  samplesDef['data4' ].set_hltPS(hltPSName)
if not samplesDef['data5' ] is None:  samplesDef['data5' ].set_hltPS(hltPSName)
if not samplesDef['data6' ] is None:  samplesDef['data6' ].set_hltPS(hltPSName)
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_weight(weightName)
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
#if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/home/jhkim/pu/DY_madgraph_Winter17_ele.pu.puTree.root')
#if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/home/jhkim/pu/DY_amcatnlo_Winter17_ele.pu.puTree.root')
#if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/home/jhkim/pu/DY_madgraph_Winter17_ele.pu.puTree.root')
...
biningDef = [
   ...
   { 'var' : 'leading_eta' , 'type': 'float', 'bins': [-2.5, 2.5] },
   #{ 'var' : 'nPV' , 'type': 'float', 'bins': [0., 3., 6., 9., 12., 15., 18., 21., 24., 27., 30., 33., 36., 39., 42., 45., 48., 51., 54., 57., 60., 63., 66., 69.] },
   { 'var' : 'nPV' , 'type': 'float', 'bins': [0., 3., 6., 9., 12., 15., 18., 21., 24., 27., 30., 33., 36., 39., 42., 45., 48., 51.] },
]
